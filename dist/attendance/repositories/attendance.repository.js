...
exports.AttendanceRepository = exports.IAttendanceRepository = void 0;
...
exports.IAttendanceRepository = Symbol('IAttendanceRepository');
let AttendanceRepository = class AttendanceRepository extends repositories_1.AbstractRepository {
    constructor(model) {
        super(model);
    }
};
