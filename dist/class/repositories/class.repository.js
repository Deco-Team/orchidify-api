...
exports.ClassRepository = exports.IClassRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const class_schema_1 = require("../schemas/class.schema");
const repositories_1 = require("../../common/repositories");
exports.IClassRepository = Symbol('IClassRepository');
let ClassRepository = class ClassRepository extends repositories_1.AbstractRepository {
    constructor(model) {
        super(model);
    }
};
