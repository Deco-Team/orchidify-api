...
exports.OtpRepository = exports.IOtpRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const repositories_1 = require("../../common/repositories");
const otp_schema_1 = require("../schemas/otp.schema");
exports.IOtpRepository = Symbol('IOtpRepository');
let OtpRepository = class OtpRepository extends repositories_1.AbstractRepository {
    constructor(model) {
        super(model);
    }
};
