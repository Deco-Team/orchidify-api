...
exports.FeedbackRepository = exports.IFeedbackRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const feedback_schema_1 = require("../schemas/feedback.schema");
const repositories_1 = require("../../common/repositories");
exports.IFeedbackRepository = Symbol('IFeedbackRepository');
let FeedbackRepository = class FeedbackRepository extends repositories_1.AbstractRepository {
    constructor(model) {
        super(model);
    }
};
