...
declare const PublicCourseInstructorDto_base: import("@nestjs/common").Type<Pick<BaseInstructorDto, "name" | "avatar" | "_id" | "bio" | "idCardPhoto">>;
declare class PublicCourseInstructorDto extends PublicCourseInstructorDto_base {
}
