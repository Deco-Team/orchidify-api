...
exports.SettingRepository = exports.ISettingRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const setting_schema_1 = require("../schemas/setting.schema");
const repositories_1 = require("../../common/repositories");
exports.ISettingRepository = Symbol('ISettingRepository');
let SettingRepository = class SettingRepository extends repositories_1.AbstractRepository {
    constructor(model) {
        super(model);
    }
};
