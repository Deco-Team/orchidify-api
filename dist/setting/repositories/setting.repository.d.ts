...
export declare const ISettingRepository: unique symbol;
export interface ISettingRepository extends AbstractRepository<SettingDocument> {
}
export declare class SettingRepository extends AbstractRepository<SettingDocument> implements ISettingRepository {
