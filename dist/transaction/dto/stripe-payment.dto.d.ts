...
export declare class CreateStripePaymentResponse {
    id: string;
...
declare const CreateStripePaymentDataResponse_base: import("@nestjs/common").Type<{
    data: typeof CreateStripePaymentResponse;
}>;
export declare class CreateStripePaymentDataResponse extends CreateStripePaymentDataResponse_base {
}
export declare class QueryStripePaymentDto {
    id: string;
}
export declare class StripePaymentResponseDto {
    amount: number;
}
export declare class RefundStripePaymentDto {
    id: string;
    amount?: number;
