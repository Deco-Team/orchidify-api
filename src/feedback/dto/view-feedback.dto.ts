...
import { FEEDBACK_LIST_PROJECTION, INSTRUCTOR_VIEW_FEEDBACK_LIST_PROJECTION } from '@feedback/contracts/constant'
...
class FeedbackLearnerDetailResponse extends PickType(BaseLearnerDto, ['_id', 'name', 'avatar']) {}
